...
export const AddMemberSchema = z.object({
  ...
  memberHusbandOccupation: z.string(),
  memberHusbandLastName: NameSchema.optional(),
  memberHusbandMobileNumber: MobileNumberSchema,
  memberHusbandQualification: z.string(),
  memberHusbandaadhaarNumber: AadharSchema,
  memberHusbandAge: AgeSchema,
  memberHusbandDob: dobSchema,
